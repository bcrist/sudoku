...
pub const White = base.Orthogonally_Adjacent_Dots(struct {
    pub inline fn validate_cells(_: @This(), _: Params, _: *const Config, _: *State, _: Cell, _: Cell, has_dot: bool, a_value: usize, b_value: usize) State.Solve_Status {
        const cells_are_consecutive = @max(a_value, b_value) - @min(a_value, b_value) == 1;
        return if (has_dot == cells_are_consecutive) .unsolved else .not_solvable;
    }
...
pub const Black = base.Orthogonally_Adjacent_Dots(struct {
    pub inline fn validate_cells(_: @This(), _: Params, _: *const Config, _: *State, _: Cell, _: Cell, has_dot: bool, a_value: usize, b_value: usize) State.Solve_Status {
        ...
        return if (has_dot == max_value_is_double) .unsolved else .not_solvable;
    }
